...
<?php
query_posts( array('category_name' => 'homepage', 'order_by' => 'date', 'order' => 'ASC') );
// the Loop
while (have_posts()) : the_post();
	...
	<div class="inner-homepage-posts">
	<h3 class="homepage-posts-subtitle"><?php the_title(); ?></h3>
	<?php if ($layout != "wide") { ?>
	<span id="homepage-posts-left">
	<?php } else { ?>
	<span id="homepage-posts">
	<?php } ?>
	<?php
		the_content();
	?>
